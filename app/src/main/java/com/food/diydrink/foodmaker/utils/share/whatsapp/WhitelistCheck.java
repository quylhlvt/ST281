package com.food.diydrink.foodmaker.utils.share.whatsapp;
...
public class WhitelistCheck {
    public static final String CONTENT_PROVIDER_AUTHORITY = "com.food.diydrink.foodmaker.utils.share.whatsapp.StickerContentProvider";
